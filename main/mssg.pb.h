...
/* Generated by nanopb-0.3.9.2 at Sun Feb 17 13:12:15 2019. */
...
#define Accel_init_default                       {0, 0, 0, 0, 0, 0, 0}
#define FinalResult_init_default                 {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define Accel_init_zero                          {0, 0, 0, 0, 0, 0, 0}
...
extern const pb_field_t Accel_fields[8];
extern const pb_field_t FinalResult_fields[5];

/* Maximum encoded size of messages (where known) */
#define Accel_size                               49
