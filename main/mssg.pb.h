...
/* Generated by nanopb-0.3.9.2 at Wed Feb 13 10:53:55 2019. */
...
#define Accel_init_default                       {0, 0, 0, 0, 0, 0, 0, 0}
#define FinalResult_init_default                 {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define Accel_init_zero                          {0, 0, 0, 0, 0, 0, 0, 0}
...
#define Accel_success_tag                        8

/* Struct field encoding specification for nanopb */
extern const pb_field_t Accel_fields[9];
extern const pb_field_t FinalResult_fields[5];

/* Maximum encoded size of messages (where known) */
#define Accel_size                               51
